...
export const getCheckList = (params) => {
  return base.mainRequest("/api/v1/driver/taxiAudit/list", params);
};
// 出租车运营商查询
export const getTaxiAgentList = (params) => {
  return base.mainRequest("/api/v1/common/taxiAgentList", params);
};
// 出租车司机审核列表
export const getTaxiGrade = (params) => {
  return base.mainRequest("/api/v1/common/taxiGrade", params);
};
// 淘汰
export const toEliminate = (params) => {
  return base.mainRequest("/api/v1/driver/taxiAudit/eliminate/submit", params);
};
// 日志
...
export const auditCheck = (params) => {
  return base.mainRequest("/api/v1/driver/taxiAudit/audit", params);
};
//
// 删除车架号活着车牌号接口
...
export const auditDetail = (params) => {
  return base.mainRequest("/api/v1/driver/taxiAudit/detail", params);
};
// 审核详情
export const auditSave = (params) => {
  return base.mainRequest("/api/v1/driver/taxiAudit/edit", params);
};
