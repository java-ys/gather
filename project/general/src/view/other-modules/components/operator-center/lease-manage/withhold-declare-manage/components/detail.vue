 ...
 * @LastEditTime: 2021-08-04 16:22:47
 * @Description:
-->
<template>
  <Modal
  ...
  >
    ...
    <Modal v-model="showSubModal" title="代扣明细" :width="800" @on-cancel="billid = ''">
      <detail :id="billid" ref="subDetail" />
    </Modal>
    <div slot="footer">
...
import detail from "./detail-new.vue"
