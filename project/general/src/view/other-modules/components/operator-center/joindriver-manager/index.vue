...
/*
  1. 按钮权限
*/
import { queryChangeCarOrderByPage } from "_o/api/joinwithcar-exchange.js";
...
const pageConfig = {
  ...
  listFunc: queryChangeCarOrderByPage,
};
  ...
  methods: {
    ...
    gotoAdut(data) {
      ...
      this.$router.push({
        ...
        query: { changeCarOrderUuid: data.changeCarOrderUuid }
      });
    },
    gotoDetails(data) {
      this.$route.meta.closeAlert = true;
