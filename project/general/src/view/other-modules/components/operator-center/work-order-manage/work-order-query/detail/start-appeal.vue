<template>
  <Card>
    <p slot="title" class="class-tit">初审申诉处理</p>
    <Form ref="formData" :model="formData" :rules="formRule">
      <Row>
        <Col span="6">
          <FormItem label="初审申诉判责结果:" prop="auditResult">
            <RadioGroup
      ...
      <Row>
        <Col span="16">
          <FormItem label="初审申诉处理描述：" prop="judgeDesc">
...
import { orderJudgeSsF } from "_o/api/work-order/wo-detail";
