...
<script>
import { rules, formData, signNumList, customizationList } from "./config.js"
import UploadFile from "../lease-contract-manage/upload.vue"
  ...
  methods: {
    ...
    confirm() {
      this.$refs.form.validate(valid => {
        ...
        this.type !== 1 ? params.contractId = this.contractId : "";
