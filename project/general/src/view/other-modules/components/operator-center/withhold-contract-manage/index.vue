<template>
  <div>
    ...
    <div class="btn-wrap">
      ...
      <Button type="primary" @click="onCreate">新增代扣合同</Button>
    </div>
    ...
    <VTable :total="total"
            ...
            class="lease-order-table-container"
...
export default {
  ...
  methods: {
    ...
    async updateContractStatus(row) {
      ...
      let params = {
        contractId: id,
        contractType: 2, // 合同类型：1 租赁合同，2 代扣合同
