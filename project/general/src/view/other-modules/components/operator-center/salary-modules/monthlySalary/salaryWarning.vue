...
<script>
import { getMonthSalaryWarning } from "_o/api/salary/salary";
import { downLoadMonthSalaryWarning } from "_o/api/salary/exportApi";
...
export default {
  ...
  methods: {
    ...
    // 司机薪酬分布
    getWeekData() {
      let params = { cityCode: this.warnForm.cityCode, salaryMonth: this.warnForm.salaryMonth };
