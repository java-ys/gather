  ...
  <div class="app-container">
      ...
      >
        ...
        <el-row>
          ...
          <el-form-item style="float: right">
            <el-button
              v-if="hasPermission('weekReward-modeUP-query')"
    ...
    <div class="main buttons export_btn_fl">
      <export-button
        ...
        :queryForm="queryForm"
        queryExport="weekReward-modeUP-export"
        @fatherExport="exportExcel"
        @loadingStatus="loadingStatus"
      ></export-button>
      <!--      <el-button v-if="hasPermission('weekReward-modeUP-export')" v-preventReClick="3000" type="primary" size="small" :disabled="exportLoading" @click="exportExcel">批量导出</el-button>-->
      <el-button
        v-if="(buttonType == 0 || buttonType == 91 || buttonType == 92) && hasPermission('weekReward-modeUP-preImport')"
        v-preventReClick="3000"
        type="primary"
        size="small"
      ...
      >离职司机维护</el-button>
      <el-button
        v-if="(buttonType == 0 || buttonType == 91 || buttonType == 92) && hasPermission('weekReward-modeUP-yingSubmit')"
        v-preventReClick="3000"
        type="primary"
        size="small"
      ...
      <el-button
        v-if="(buttonType == 3 && exButtonType == 0) && hasPermission('weekReward-modeUP-afterImport') && compareTime"
        v-preventReClick="3000"
        type="primary"
        size="small"
      ...
      >税后补发补扣导入</el-button>
      <el-button
        v-if="(buttonType == 3 && exButtonType == 0 ) && hasPermission('weekReward-modeUP-complete') && compareTime"
        v-preventReClick="3000"
        type="primary"
        size="small"
      ...
      <el-button
        v-if="(buttonType == 3 && exButtonType == 1 ) && hasPermission('weekReward-modeUP-cancel') && compareTime"
        v-preventReClick="3000"
        type="primary"
        size="small"
      ...
      <el-button
        v-if="(buttonType == 3 && exButtonType == 1) && hasPermission('weekReward-modeUP-actualSubmit') && compareTime"
        v-preventReClick="3000"
        type="primary"
        size="small"
      ...
      >提交周实发审核</el-button>
      <el-button
        v-if="(buttonType == 5 || buttonType == 6 ) && hasPermission('weekReward-modeUP-reeult')"
        v-preventReClick="3000"
        type="primary"
        size="small"
      ...
      >
        ...
        >
          <template slot-scope="scope">
            ...
            <el-button
              v-if="
                hasPermission('weekReward-modeUP-edit') &&
            ...
            >编辑</el-button>
            <el-button
              v-if="hasPermission('weekReward-modeUP-log')"
              size="mini"
              type="text"
            ...
            <!-- <el-button
              v-if="
                hasPermission('weekReward-modeUP-preModify') &&
                  (scope.row.flowStatus == 0 || scope.row.flowStatus == 91 || scope.row.flowStatus == 92)
              "
              size="mini"
              type="text"
            ...
            <el-button
              v-if="
                hasPermission('weekReward-modeUP-afterModify') &&
            ...
            <!-- <el-button
              v-if="
                hasPermission('weekReward-modeUP-preDetail')
              "
              size="mini"
              type="text"
            ...
            <el-button
              v-if="
                hasPermission('weekReward-modeUP-afterDetail')
              "
              size="mini"
              type="text"
    ...
    async exportExcel() {
      ...
      if (Object.keys(requestParams).length === 0 || !requestParams["cityCode"]) {
        ...
        if (data.success) {
          ...
          // 导出任务对应的code枚举
          exportParams.dataExportCode = "odb-driverWeekSalaryReport-service"
