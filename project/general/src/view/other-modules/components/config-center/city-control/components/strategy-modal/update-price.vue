  ...
  <div>
    ...
    >
      ...
      <div class="flex-box">
        ...
        <FormItem v-if="params.expandBizLine !== 13" label="是否一口价:" prop="fixedPriceFlag">
      ...
      <div>
        ...
        <Card v-if="params.startFareStatus" class="mt10" dis-hover>
      ...
      <div>
        ...
        <Card v-if="params.lowestFareStatus" class="mt10" dis-hover>
          <Button
            v-if="addViewStatus"
            type="primary"
            size="small"
          ...
          <div v-if="params.lowestFareStatus">
            ...
            >
              ...
              <FormItem label="基础费(元):" prop="unitPrice" :label-width="150">
...
export default {
  ...
  computed: {
    ...
    // expandBizLine() {
    //   return this.params.expandBizLine // 业务线
    // }
  },
  watch: {
    value() {
  ...
  methods: {
    ...
    validatePassenger() {
      ...
      //   areaCodes: this.params.areaCodes,
      //   businessType: this.params.businessType,
      //   carLevel: this.params.carLevel,
      //   typeTime: this.params.typeTime,
      //   fixedPriceFlag: this.params.fixedPriceFlag,
      //   effectiveTime: this.params.effectiveTime,
      //   workRestDayList: this.params.workRestDayList,
      //   startFareStatus: this.params.startFareStatus,
      //   startTrip: this.params.startTrip,
      //   startDuration: this.params.startDuration,
      // }
