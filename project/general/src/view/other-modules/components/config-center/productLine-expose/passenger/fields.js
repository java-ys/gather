          ...
          return h(
            'img', {
              style: {
                ...
                height: '40px',
                borderRadius: '50%',
                display: params.row.picUrl ? 'block' : 'none'
          ...
          return h('div', [
            h(
              'Button', {
                ...
                directives: [{
                  name: 'hasAuth',
                  value: 'passenger-edit'
                }],
                on: {
                  click: () => {
                    _this.goEdit(paramData.id)
                  }
                }
              },
              '编辑'
            ...
            h(
              'Button', {
                ...
                directives: [{
                  name: 'hasAuth',
                  value: 'passenger-white-list'
                }],
                on: {
                  click: () => {
                    _this.gotoWhitelist(paramData)
                  }
                }
              },
              '白名单管理'
...
export const gerProductLineName = {
  4: "快享",
  2: "专享",
  5: "顺风车",
  10: "包车",
