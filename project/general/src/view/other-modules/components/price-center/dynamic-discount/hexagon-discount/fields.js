...
export const listColumns = {
  columns(_this) {
    ...
    },
    {
      ...
      key: "typeTimeList",
      render: (h, params) => {
        return h("div", getTypeTimeName(params.row.typeTimeList))
      }
    },
    {
      title: "车型等级",
      ...
      key: "carLevelList",
      render: (h, params) => {
        const { row: { serviceType, carLevelList }} = params
        const { productCarKeyValue } = _this.businessGradeName
        return h("div", productCarKeyValue[`${serviceType}#${carLevelList}`])
      }
    },
    {
      title: "城市",
