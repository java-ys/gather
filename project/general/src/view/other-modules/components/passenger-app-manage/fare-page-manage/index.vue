  ...
  <div>
    ...
    >
      <div class="default-demo">
        <img src="../../../assets/fare-config-demo/fare-demo.png" />
        <img src="../../../assets/fare-config-demo/fare-detail-demo.png" />
      </div>
    </Modal>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    async handleSubmit(params) {
      ...
      try {
        const { ...query } = params
        const res = await request({ ...query, strategyType: 1 })
        if (res.data.success) {
