  ...
  <div>
    ...
    >
      <div>
        ...
        <FormItem label="使用城市" prop="cityUuids" style="margin-top: 25px;">
          <Cascader
            :data="cityList"
            v-model="commonFormData.cityUuids"
            style="width: 200px;"
          ></Cascader>
        </FormItem>
      </div>
    ...
    <div class="popView-footer-wrap">
      <Button
        size="large"
        type="text"
        v-lazy-click="{ fn: commit, params: { temp: 0 } }"
      ...
      <Button
        size="large"
        type="primary"
        v-lazy-click="{ fn: commit, params: { temp: 1 } }"
        >确定</Button
      >
    </div>
  </div>
