...
<template>
  <div>
    <div class="pagetitle" v-if="false">
      <p>车辆分布图</p>
    ...
    <div class="maprea" ref="area">
          ...
          <div class="contents">
            <div class="drivermsg">
              ...
              <div class="driver-item bottom15">
                <p>司机电话</p>
                <div>
                  <span class="hascolor">{{ phoneDesensitization(driverMsgData.mobile) || '暂无' }}</span>
                  <Icon
                    v-if="false"
                    type="ios-mail"
                    size="26"
      ...
      <!--</div>-->
      <!-- 左侧条件查询 -->
      <div class="leftshadow" v-if="true">
        <div class="locationquery borderbottom" style="margin-top: 0px">
          <div class="selectline disflexstyle">
            <div class="selecttitles" style="width: 126px;">
              城市名
            </div>
            <Input :value="$route.query.cityName || ''" :disabled="true" />
          </div>
          <div class="selectline disflexstyle">
            <div class="selecttitles" style="width: 126px;">
              车牌号
            </div>
            <Input :value="$route.query.carNo || ''" :disabled="true" />
          </div>
        </div>
        <!-- 城市 -->
        <div class="locationquery borderbottom" style="margin-top: 50px" v-if="false">
          <div class="selectline disflexstyle">
        ...
        <div class="locationquery">
          ...
          <div class="selectline" v-if="false">
      ...
      <div class="lefttopshadow">
        ...
        >
          ...
          />
          <p :style="{'color': ishowThermogram? '#2d8cf0' : ''}">
            热力图
          </p>
        </div>
        <div
    ...
    >
      <Row>
        ...
        <div class="disstyle">
          ...
          <div class="sentchoice">
            {{ phoneDesensitization(driverMsgData.mobile) || '暂无' }}
          </div>
        </div>
        </Col>
      </Row>
    ...
    >
      <div class="disstyle">
        ...
        <div class="sentchoice">
          {{ phoneDesensitization(driverMsgData.mobile) }}
        </div>
      </div>
      <div class="messagedistance">
        <p class="sendobj sendtitle">
...
import { getAppointedProvinceCityInAuth,getAgentByCityAuth } from "../api/common.js";
...
import { routeList } from '../api/configData'
...
export default {
  ...
  methods: {
    ...
    getElefenceList(val, type) {
      const { cityCode } = this.$route.query
    ...
    searchApiFormCustomer() {
      const { cityCode, carNo } = this.$route.query
      const data = {
        cityID: cityCode,
        carNoOrMobile: carNo
      }
