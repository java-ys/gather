    ...
    <div class="qrcode_box">
      <a v-if="!isFirefox" @click.stop.prevent="downloadQrImg">
        ...
        <img
          ...
          alt="二维码图片"
        />
        <Button :type="btnType" :ghost="btnType?true:false" size="small" v-if="!isImg">保存二维码</Button>
      </a>
      <a v-if="isFirefox" :href="qrcodeImg" download="二维码图片.png" class="qrcode">
        <!-- 带logo和文字的二维码图片 -->
        <img
          class="qrcode_canvas"
          style="border:1px solid #ddd;"
      ...
      <!-- logo图片 -->
      <img v-if="qrLogo" class="qrcode_logo" ref="qrcode_logo" :src="qrLogo" alt="logo图片" />
...
import logo from "_g/assets/images/qrcode/small-logo.png";
export default {
  /**
